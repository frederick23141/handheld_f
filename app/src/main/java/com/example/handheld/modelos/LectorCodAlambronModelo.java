...
public class LectorCodAlambronModelo {
    ...
    public LectorCodAlambronModelo(String numero_transaccion, String codigoalambron, String pesoAlambron, String num_imp, String detalle,String consecutivo,String num_rolloAlambron,String estado_muestra,String nit_proveedor,String costo_unitario_alambron) {
    ...
    public LectorCodAlambronModelo() {
    }
